...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/consultor/reset-password', {
        method: 'POST',
        ...
        <div className="w-full max-w-md">
          <Card className="shadow-2xl bg-white border border-gray-200 overflow-hidden">
            ...
            <CardContent className="space-y-4 pt-2 pb-6">
              <Link href="/consultor/forgot-password" className="block">
...
export default function ConsultorResetPasswordPage() {
  return (
    <Suspense fallback={
