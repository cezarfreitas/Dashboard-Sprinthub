...
<svg width="${width}" height="${totalHeight}" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <style>
      ...
      .title { font-family: 'Inter', Arial, sans-serif; font-size: 42px; font-weight: 900; fill: #111827; }
      .subtitle { font-family: 'Inter', Arial, sans-serif; font-size: 18px; font-weight: 600; fill: #6b7280; }
      .cardLabel { font-family: 'Inter', Arial, sans-serif; font-size: 12px; font-weight: 800; fill: #6b7280; letter-spacing: 0.6px; text-transform: uppercase; }
      .cardValue { font-family: 'Inter', Arial, sans-serif; font-size: 22px; font-weight: 900; fill: #111827; }
      .cardValueGreen { font-family: 'Inter', Arial, sans-serif; font-size: 22px; font-weight: 900; fill: #059669; }
      .header-text { font-family: 'Inter', Arial, sans-serif; font-size: 13px; font-weight: 700; fill: #374151; text-transform: uppercase; letter-spacing: 0.5px; }
      .cell-text { font-family: 'Inter', Arial, sans-serif; font-size: 15px; font-weight: 600; fill: #1f2937; }
      .cell-number { font-family: 'Inter', Arial, sans-serif; font-size: 15px; font-weight: 700; fill: #059669; }
      .cell-muted { font-family: 'Inter', Arial, sans-serif; font-size: 14px; font-weight: 700; fill: #111827; }
      .footer-text { font-family: 'Inter', Arial, sans-serif; font-size: 20px; font-weight: 900; fill: #111827; }
      .footer-number { font-family: 'Inter', Arial, sans-serif; font-size: 22px; font-weight: 900; fill: #059669; }
      .footer-small { font-family: 'Inter', Arial, sans-serif; font-size: 13px; font-weight: 500; fill: #9ca3af; }
    </style>
