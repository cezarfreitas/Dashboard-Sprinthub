...
export async function POST(request: NextRequest) {
  try {
    ...
    const resetLink = `${baseUrl}/consultor/reset-password?token=${resetToken}`
      ...
      <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5;">
        <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
          <div style="background-color: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
            <!-- Header -->
            <div style="background: linear-gradient(135deg, ${empresaConfig.corPrincipal} 0%, ${empresaConfig.corPrincipal}dd 100%); padding: 30px; text-align: center;">
            ...
            <div style="padding: 40px 30px;">
              ...
              <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                Recebemos uma solicitação para redefinir a senha da sua conta de consultor.
              </p>
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${resetLink}" style="display: inline-block; background-color: ${empresaConfig.corPrincipal}; color: white; text-decoration: none; padding: 14px 40px; border-radius: 8px; font-weight: 600; font-size: 16px;">
                  Redefinir Senha
                </a>
              </div>
