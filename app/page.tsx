      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground font-body">
            Funil de Vendas{user ? `, ${user.name || user.username}` : ''}.
          </p>
        </div>
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="p-2 border-b bg-card">
          <div className="flex items-center justify-between mb-2">
            <div>
              <h1 className="text-base font-bold text-primary">Funil de Vendas</h1>
        ...
        <div className="flex-1 overflow-x-auto p-1">
          <div className="flex items-center w-full gap-1">
            ...
            <Card className="w-[50px] border-0 shadow-none flex-shrink-0">
          ...
          {funilData.colunas.map((coluna, index) => {
            ...
            return (
              <div key={coluna.id} className="flex items-center">
                ...
                <Card className="flex-1 min-w-[80px] border-0 shadow-none">
