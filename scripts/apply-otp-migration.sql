-- Aplicar migration manualmente (se o script .sh não funcionar)
-- Execute este arquivo no MySQL Workbench ou via linha de comando
...
CREATE INDEX IF NOT EXISTS idx_email_code_valid ON otp_codes (email, code, verified, expires_at);

-- Verificar se a tabela foi criada
SELECT 'Tabela otp_codes criada com sucesso!' AS status;
