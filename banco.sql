...
--
-- Estrutura para tabela `colunas_funil`
--
...
--
-- Estrutura para tabela `contatos_whatsapp`
--
...
--
-- Estrutura para tabela `cron_sync_history`
--
...
--
-- Estrutura para tabela `fila_leads_log`
--
...
--
-- Estrutura para tabela `motivos_de_perda`
--
...
--
-- Estrutura para tabela `notificacao_oportunidades`
--
...
CREATE TABLE `unidades` (
  ...
  `imagem` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL/caminho da imagem (ex: /api/uploads/unidades/unidade-1-123.png)',
...
--
-- Estrutura para tabela `unidade_grupos`
--
...
--
-- Estrutura para tabela `vendedores_ausencias`
--
...
--
-- Índices de tabela `colunas_funil`
--
...
--
-- Índices de tabela `contatos_whatsapp`
--
...
--
-- Índices de tabela `cron_sync_history`
--
...
--
-- Índices de tabela `fila_leads_log`
--
...
--
-- Índices de tabela `motivos_de_perda`
--
...
--
-- Índices de tabela `notificacao_oportunidades`
--
...
--
-- Índices de tabela `unidade_grupos`
--
...
--
-- AUTO_INCREMENT de tabela `fila_leads_log`
--
ALTER TABLE `fila_leads_log`
...
--
-- AUTO_INCREMENT de tabela `notificacao_oportunidades`
--
ALTER TABLE `notificacao_oportunidades`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `unidade_grupos`
--
ALTER TABLE `unidade_grupos`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `vendedores_ausencias`
--
ALTER TABLE `vendedores_ausencias`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
