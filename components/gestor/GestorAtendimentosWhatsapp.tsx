    ...
    return (
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-semibold">Atendimentos Whatsapp</CardTitle>
        </CardHeader>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle className="text-base font-bold text-gray-900 flex items-center gap-2">
                <svg className="h-4 w-4 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                Estatísticas de conversas e interações
              </p>
            </div>
          </div>
          {lastUpdate && (
